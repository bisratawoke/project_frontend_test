...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fhome&absolutePagePath=C%3A%5CUsers%5CPublic%5Cprojects%5Cproject_frontend_test%5Cpages%5Chome.js!./":
/*!*******************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2Fhome&absolutePagePath=C%3A%5CUsers%5CPublic%5Cprojects%5Cproject_frontend_test%5Cpages%5Chome.js ***!
  \*******************************************************************************************************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _Components_Redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Components/Redux */ "./Components/Redux.js");




var _jsxFileName = "C:\\Users\\Public\\projects\\project_frontend_test\\pages\\home.js",
    _s = $RefreshSig$();
...
function home() {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_3__["useContext"])(_Components_Redux__WEBPACK_IMPORTED_MODULE_4__["Context"]),
      state = _useContext.state,
      dispatch = _useContext.dispatch;

  var formRef = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  var dropZoneRef = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  var data = Object(react__WEBPACK_IMPORTED_MODULE_3__["useRef"])(null);
  var url = 'http://localhost:5000/upload';
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    data.current = new FormData(); //drop zone events handler register

    dropZoneRef.current.addEventListener('dragenter', function (evnt) {
      return genericHandler(evnt, 'blue');
    });
    dropZoneRef.current.addEventListener('dragleave', function (evnt) {
      return genericHandler(evnt, 'grey');
    });
    dropZoneRef.current.addEventListener('dragover', function (evnt) {
      return genericHandler(evnt, 'yellow');
    });
    dropZoneRef.current.addEventListener('drop', dropHandler); //form submit handler register

    formRef.current.addEventListener('submit', upload);
  }, []); // form upload handler

  var upload = /*#__PURE__*/function () {
    var _ref = Object(C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(evnt) {
      var opt, response;
      return C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              evnt.preventDefault();
              data.current.append('domain', evnt.target.domain.value); //request options

              opt = {
                headers: {
                  'Authorizartion': "token ".concat(state.token)
                },
                method: 'POST',
                body: data.current
              }; //request api
              ...
              _context.next = 6;
              return fetch("".concat(url, "?domain=").concat(evnt.target.domain.value), opt);
  ...
  var genericHandler = function genericHandler(evnt, color) {
    evnt.preventDefault();
    evnt.stopPropagation();
    evnt.target.setAttribute('style', "border:2px solid ".concat(color, ";padding:20px "));
  }; //dropHandler


  var dropHandler = /*#__PURE__*/function () {
    var _ref2 = Object(C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(e) {
      return C_Users_Public_projects_project_frontend_test_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              e.stopPropagation();
              getContent(e.dataTransfer);
    ...
    return function dropHandler(_x2) {
      return _ref2.apply(this, arguments);
    };
  }(); //get content


  var getContent = function getContent(dataTransfer) {
    for (var x = 0; x < dataTransfer.items.length; x++) {
      var item = dataTransfer.items[x];
      ...
      if (item.kind == 'file') {
        if (typeof item.webkitGetAsEntry == 'function') {
          ...
          if (entry.isDirectory) {
            folderAppender(entry);
          } else if (entry.isFile) {
            console.log('do i even run');
          }
        }
      }
    } //folder Appender function


    function folderAppender(entry) {
      var reader = entry.createReader();
      reader.readEntries(function (entries) {
        entries.forEach(function (en) {
          if (en.isFile) {
            fileAppender(en, en.fullPath);
          } else {
            folderAppender(en);
          }
        });
    ...
    function fileAppender(entry, fullpath) {
      entry.file(function (file) {
        data.current.append(fullpath, file);
      });
    }
  };
...
_s(home, "f8ldyR+PivrEF2ROBNzRYxWQF/U=");
